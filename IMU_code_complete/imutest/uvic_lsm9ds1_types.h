...
#ifndef _uvic_lsm9ds1_types_h
#define _uvic_lsm9ds1_types_h
...
//GET FUNCTION ENUMS//
//////////////////////
//The following series of enum types are fed to the various "get" functions to narrow down exactly what measurement is being asked for.
//This allows us to use only two get functions (getVal for one dimension and getTrio for three dimensions) instead of a zillion when writing to serial.

enum axis_spec{
  AXIS_X,
  AXIS_Y,
  AXIS_Z,
  AXIS_PYTHAGORAS //magnitude of three dimensions combined
};
...
//SETTINGS ENUMS//
//////////////////
//These types are used to set up the board as desired
...
//the thermometer has no settings to speak of
